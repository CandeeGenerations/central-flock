...
export const PrintPage = forwardRef<
  HTMLDivElement,
  {children: ReactNode; className?: string; paddingX?: number; orientation?: PageOrientation}
>(function PrintPage({children, className, paddingX = PAGE_PADDING_X_PX, orientation = 'portrait'}, ref) {
  return (
    <div
      ref={ref}
      className={className}
